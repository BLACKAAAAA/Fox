...
local RunBot = io.open("RocKs", 'w')
RunBot:write([[
#!/usr/bin/env bash
cd $HOME/RocKs
token="]]..database:get(Server_Done.."Token_Write")..[["
rm -fr RocKs.lua
wget "https://raw.githubusercontent.com/BLACKAAAAA/RocKs/main/RocKs.lua"
while(true) do
rm -fr ../.telegram-cli
./tg -s ./RocKs.lua -p PROFILE --bot=$token
done
]])
RunBot:close()
...
while(true) do
rm -fr ../.telegram-cli
screen -S RocKs -X kill
screen -S RocKs ./RocKs
done
]])
RunTs:close()
end
